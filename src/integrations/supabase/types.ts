  ...
  public: {
    Tables: {
      ...
      point_balances: {
        ...
        Relationships: [
          {
            foreignKeyName: "point_balances_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: true
            referencedRelation: "clients"
            referencedColumns: ["id"]
      ...
      point_ledger: {
        ...
        Relationships: [
          {
            foreignKeyName: "point_ledger_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
      ...
      point_sale_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "point_sale_requests_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
      ...
      points_ledger: {
        ...
        Relationships: [
          {
            foreignKeyName: "points_ledger_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
      ...
      points_sell_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "points_sell_requests_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
